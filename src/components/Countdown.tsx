...
export default function Countdown({ targetDate }: CountdownProps) {
  ...
  return (
    <div className="flex flex-col items-center gap-3">
      <p className="text-sm text-[#BD8C84] font-semibold tracking-wider font-[family-name:var(--font-heebo)] uppercase">
        המבצע מסתיים בעוד
      </p>
        ...
        {blocks.map((block) => (
          <div key={block.label} className="flex flex-col items-center">
            <motion.div
              ...
              className="relative w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-b from-[#1E1E1E] to-[#151515] border border-white/10 rounded-xl flex items-center justify-center"
            >
              {/* Rose top accent line */}
              <div className="absolute top-0 left-2 right-2 h-[2px] bg-gradient-to-r from-transparent via-[#BD8C84] to-transparent" />
